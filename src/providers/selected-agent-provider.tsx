...
import { AGENT_WALLETS as CHAIN_AGENT_WALLETS } from "../../modules/shared/chain"
...
// Agent bech32 addresses on the agentbet-1 rollup — sourced from
// modules/shared/chain.ts, which is regenerated by fund-and-deploy.sh
// each time a rollup is deployed (per Codespace / per local env).
const AGENT_WALLETS: Record<AgentName, string> = {
  Llama: CHAIN_AGENT_WALLETS.Llama?.address ?? "",
  Mistral: CHAIN_AGENT_WALLETS.Mistral?.address ?? "",
  Nemotron: CHAIN_AGENT_WALLETS.Nemotron?.address ?? "",
  Qwen: CHAIN_AGENT_WALLETS.Qwen?.address ?? "",
}
