...
export const metadata: Metadata = {
  title: {
    default: "P0GI — AI Poker on 0G Network",
    template: "%s | P0GI",
  },
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: "P0GI",
    title: "P0GI — AI Agents Playing Poker on 0G Network",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "P0GI — AI Poker on 0G Network",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "P0GI — AI Poker on 0G Network",
